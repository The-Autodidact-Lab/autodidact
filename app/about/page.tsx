...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(148,163,184,0.25),transparent_60%),radial-gradient(circle_at_bottom,_rgba(129,140,248,0.25),transparent_60%)] opacity-50" />

      <div className="relative mx-auto max-w-[var(--container)] px-4 pb-20 pt-28 sm:pb-28 sm:pt-32">
        {/* ABOUT VIEWPORT */}
        <section className="mb-10 sm:mb-12">
          <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white/95 shadow-[0_18px_70px_rgba(15,23,42,0.08)]">
            <div className="grid gap-8 p-8 sm:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] sm:p-10 lg:p-12">
              <div className="space-y-5 sm:space-y-6">
                ...
                <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl lg:text-[2.7rem] lg:leading-tight">
              ...
              <div className="flex flex-col justify-between gap-6 rounded-3xl bg-[radial-gradient(circle_at_top,_rgba(148,163,255,0.18),transparent_55%),radial-gradient(circle_at_bottom,_rgba(56,108,212,0.18),transparent_60%)] p-6">
                <div className="space-y-3">
                  <p className="text-[0.8rem] uppercase tracking-[0.32em] text-slate-500">
                    Orientation
                  </p>
                  <p className="text-sm leading-relaxed text-slate-900/85">
        ...
        {/* OUR TEAM HEADER */}
        <section className="justify-center items-center text-center mb-4 sm:mb-6">
          <h2 className="font-sans text-[4rem] font-semibold tracking-tight text-slate-900 sm:text-[4rem] lg:text-[5rem]">
            Our Team
          </h2>
        </section>
        ...
        <section className="mb-10 sm:mb-14">
          <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white/95 shadow-[0_18px_70px_rgba(15,23,42,0.06)]">
            <div className="px-6 pb-7 pt-6 sm:px-10 sm:pb-8 sm:pt-7">
              <div className="space-y-6">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    {TEAM.map((member) => (
                      <article
                        key={member.name}
                        className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-slate-50/60 px-5 py-6 text-left shadow-[0_10px_40px_rgba(15,23,42,0.04)]"
                      >
                        <div className="mb-4 flex items-start gap-4 sm:gap-5">
                          {member.imageSrc && (
                            <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-2xl bg-slate-200 sm:h-20 sm:w-20">
                              <Image
                                src={member.imageSrc}
                          ...
                          <div className="min-w-0 space-y-1.5">
                            ...
                            <p className="text-[0.7rem] uppercase tracking-[0.22em] text-slate-500 sm:text-xs">
                              {member.role}
                            </p>
                          </div>
                        </div>
                ...
                <div className="mt-4">
                  <div className="mb-2 text-[0.65rem] uppercase tracking-[0.3em] text-slate-500">
                    Collaborators
                  </div>
                  <div className="ticker rounded-2xl border border-slate-200 px-4 py-3">
                    <div className="ticker-track">
                      {[...COLLABORATORS, ...COLLABORATORS].map(
                        (collab, index) => (
                          <div
                            key={`${collab.name}-${index}`}
                            className="flex items-center gap-3 rounded-full bg-white/80 px-4 py-2 text-xs text-slate-700 shadow-[0_4px_18px_rgba(15,23,42,0.08)]"
                          >
                            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-indigo to-blue text-[0.8rem] font-medium text-slate-50">
        ...
        <section className="mb-4 sm:mb-4">
          <div className="mb-4 text-center text-[0.8rem] uppercase tracking-[0.3em] text-slate-500">
            Backed by
          </div>
          <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-center gap-4 sm:gap-6">
            {BACKERS.map((label) => (
              <div
                key={label}
                className="flex h-12 w-32 items-center justify-center rounded-2xl border border-slate-200 bg-slate-100 shadow-[0_10px_32px_rgba(15,23,42,0.08)]"
                aria-label={label}
              >
                <div className="flex h-6 w-20 items-center justify-center rounded-xl bg-slate-300/90">
